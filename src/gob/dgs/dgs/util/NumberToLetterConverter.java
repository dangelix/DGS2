...
/**
 * <p>Esta clase se a adecuo a partir del ejemplo en <em>https://github.com/Axiacore/numero-a-letras/blob/master/java/NumberToLetterConverter.java</em>. </p>
 * <p>Esta clase tiene el prop&oacute;sito de convertir importes expresados en n&uacute;meros a su representaci�n con letra.</p>
 */
public class NumberToLetterConverter {
    ...
    /**
     * Evita la creaci&oacute;n una nueva instancia de la clase usando la palabra 
